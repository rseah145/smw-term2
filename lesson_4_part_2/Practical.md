...
Applying 3 Computer Configuration settings in "Removable Storage Access" to the newly created GPO (Policies -> Administrative Templates -> System -> Removable Storage Access)
...
4. Create a html page with the name "default.htm" in C:\\\\sslDemoWeb  
```html
<html>
<head>
</head>
...
![image](../images/Pasted%20image%2020230819220605.png)  
![image](../images/Pasted%20image%2020230819220625.png)  
...
3. Login as mgr1 (Domain User) to the Win10 client, enroll a User Cert for mgr1. Access https://<FQDN of server1\>/MutualSSL, the webpage should load without any error (Enroll a user cert through the web interface or through certificates snap-in via MMC for current user, NOT local computer)  

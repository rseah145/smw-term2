...
3. Login as mgr1 (Domain User) to the Win10 client, enroll a User Cert for mgr1. Access https://<FQDN of server1\>/MutualSSL, the webpage should load without any error  

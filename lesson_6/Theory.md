...
Scenario C, Tunnel between router and IPsec software running on HR Server where tunnel endpoints are the router (Alice PC's router) and the HR server. Difference between this and Scenario B is 
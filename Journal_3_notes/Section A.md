...
Authenticators are a record containing info that can be shown to be recently generated using the session key only known to the client and the server. Allows the user to authenticate to the service, and the service to authenticate to the user
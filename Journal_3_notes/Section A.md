...
Note: Pipe into more for viewing each line, line-by-line is optional " | more", just remove " | more" from the command to view it without viewing the output of a command line-by-line

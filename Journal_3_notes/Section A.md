...
3. Client sends a login request to the DC, as the PC has joined the domain, the DC knows the hash value associated to the login name (username) (all hash values for all users)
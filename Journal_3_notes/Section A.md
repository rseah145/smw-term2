...
5. The File Server ticket is then sent to the client and is stored within the client's Kerberos Tray. For the next 8 hours (or for how long the ticket is set to be valid),  

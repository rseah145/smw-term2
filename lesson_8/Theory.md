...
| IKEv2 | IPsec with AES 256-bit key | 500&#160;UDP<br>4500&#160;UDP| Windows, Blackberry | Considered to be a fast and extremely secure protocol.<br>Supports mobility (MOIKE)